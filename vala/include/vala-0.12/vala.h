...
gint vala_attribute_get_integer (ValaAttribute* self, const gchar* name);
...
gchar* vala_data_type_get_lower_case_cname (ValaDataType* self, const gchar* infix);
...
void vala_interface_set_lower_case_csuffix (ValaInterface* self, const gchar* csuffix);
...
void vala_lambda_expression_add_parameter (ValaLambdaExpression* self, const gchar* param);
...
ValaCCodeConstant* vala_signal_get_canonical_cconstant (ValaSignal* self, const gchar* detail);
...
void vala_variable_set_array_length_cexpr (ValaVariable* self, const gchar* array_length_cexpr);
...
void vala_variable_set_no_delegate_target (ValaVariable* self, gboolean value);

...
namespace Vala {
	...
	[CCode (ref_function = "vala_iterable_ref", unref_function = "vala_iterable_unref", cheader_filename = "valagee.h")]
	public abstract class Iterable<G> {
		public Iterable ();
		public abstract GLib.Type get_element_type ();
		public abstract Vala.Iterator<G> iterator ();
	}
	[CCode (ref_function = "vala_iterator_ref", unref_function = "vala_iterator_unref", cheader_filename = "valagee.h")]
	...
	[CCode (ref_function = "vala_map_ref", unref_function = "vala_map_unref", cheader_filename = "valagee.h")]
...
namespace Vala {
	...
	[CCode (ref_function = "vala_ccode_file_ref", unref_function = "vala_ccode_file_unref", cheader_filename = "valaccode.h")]
...
namespace Vala {
	...
	public class PhiFunction {
		...
		public Vala.List<Vala.LocalVariable?> operands { get; private set; }
		public Vala.LocalVariable original_variable { get; private set; }
	}
	[CCode (cheader_filename = "vala.h")]
	...
	public class SourceFile {
		public SourceFile (Vala.CodeContext context, Vala.SourceFileType type, string filename, string? content = null);
		public void accept (Vala.CodeVisitor visitor);
	...
	[CCode (ref_function = "vala_target_value_ref", unref_function = "vala_target_value_unref", cheader_filename = "vala.h")]
	...
	[CCode (cprefix = "VALA_CODE_WRITER_TYPE_", cheader_filename = "vala.h")]
	...
	[CCode (cprefix = "VALA_MEMBER_BINDING_", cheader_filename = "vala.h")]
	...
	[CCode (cprefix = "VALA_SOURCE_FILE_TYPE_", cheader_filename = "vala.h")]
...
namespace Vala {
	...
	public abstract class CCodeBaseModule : Vala.CodeGenerator {
		...
		public virtual void generate_marshaller (Vala.List<Vala.Parameter> @params, Vala.DataType return_type, bool dbus = false);
		...
		public Vala.CCodeExpression get_unref_expression (Vala.CCodeExpression cvar, Vala.DataType type, Vala.Expression? expr, bool is_macro_definition = false);
	...
	public class GLibValue : Vala.TargetValue {
		...
		public GLibValue (Vala.DataType? value_type = null, Vala.CCodeExpression? cvalue = null);
	...
	public class GSignalModule : Vala.GObjectModule {
		...
		public override void generate_marshaller (Vala.List<Vala.Parameter> @params, Vala.DataType return_type, bool dbus = false);
		public virtual Vala.CCodeExpression get_dbus_g_type (Vala.DataType data_type);
		public override string get_marshaller_function (Vala.List<Vala.Parameter> @params, Vala.DataType return_type, string? prefix = null, bool dbus = false);
